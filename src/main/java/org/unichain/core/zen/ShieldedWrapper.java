...
import org.unichain.api.GrpcAPI.DecryptNotes.NoteTx;
import org.unichain.common.utils.Base58;
import org.unichain.common.utils.ByteArray;
import org.unichain.common.utils.Utils;
import org.unichain.core.exception.CipherException;
import org.unichain.keystore.SKeyCapsule;
import org.unichain.keystore.SKeyEncryptor;
...
public class ShieldedWrapper {
  ...
  private void updateNoteWhetherSpend() throws Exception {
    for (Entry<Long, ShieldedNoteInfo> entry : utxoMapNote.entrySet()) {
      ...
      builder.setTxid(ByteString.copyFrom(ByteArray.fromHexString(noteInfo.getUnxId())));
